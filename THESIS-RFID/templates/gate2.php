...
function getGateData($conn, $gate) {
    $gateValue = ($gate == 2) ? 'Gate 1' : 'Gate 2';
...
// Fetch data for Gate 2
$gate1Data = getGateData($conn, 2);
    ...
    <div class="container-container">
        <div class="details" id="dashboard">
            ...
            <section class="gateinterface">
                <div class="gateinfo">
                    <div class="gatephoto">
                        <img id="student-photo" src="<?= $photoPath; ?>" alt="Gate 2 Photo">
                    </div>
                    <div class="gatedata">
